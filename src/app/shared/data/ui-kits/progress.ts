...
export const ProgressBarsStriped: progress[] = [
    {
        mainTitle: 'Striped Bar',
        title: 'Add <code>.progress-bar-striped</code> class to set the striped progress-bar',
        item: [
            {
                value: '10%',
...
export const CustomProgressbars = [
    ...
    {
        value: '100%',
        class: 'progress-bar-animated progress-bar-striped bg-dark text-center text-light',
        text: '100% Completed'
    },
];
