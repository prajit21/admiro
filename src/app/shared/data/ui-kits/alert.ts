...
export const OutlineDarkAlert: Alert[] = [
    {
        class: 'text-primary border-primary alert-dismissible fade show',
        icon: 'clock',
        text: "One of <strong>YouTube's </strong>most crucial ranking factors is watch Time."
    },
    {
        class: 'text-success border-success outline-2x alert-dismissible fade show alert-icons mb-0"',
        icon: 'thumbs-up',
...
export const AdditionalContent = [
    ...
    },
    {
        ...
        class: 'alert alert-light-success mb-0',
        color: ' txt-success'
    },
];