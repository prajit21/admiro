...
export const ContextualClasses = [
    {
        class: 'primary',
        list: 'This is Primary bg you can use <em class="text-primary fw-bold">.list-group-item-primary</em>  class.'
    },
    {
        class: 'secondary',
        list: 'This is secondary bg you can use <em class="text-secondary fw-bold">.list-group-item-secondary</em>  class.'
    },
    {
        class: 'success',
        list: 'This is Success bg you can use <em class="text-success fw-bold">.list-group-item-success</em>  class.'
    },

    {
        class: 'danger',
        list: 'This is Danger bg you can use<em class="text-danger fw-bold">.list-group-item-danger</em> class.'
    },
    {
        class: 'warning',
        list: 'This is warning bg you can use<em class="text-warning fw-bold">.list-group-item-warning</em> class.'
    },
    {
        class: 'info',
        list: 'This is Info bg you can use<em class="text-info fw-bold">.list-group-item-info</em> class.'
    },
