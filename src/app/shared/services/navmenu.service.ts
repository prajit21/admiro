...
export class NavmenuService {
  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      active: true,
      children: [
        { path: "/dashboard/default", des: true, title: "Default", type: "link" },
        { path: "/dashboard/ecommerce", des: true, title: "Ecommerce", type: "link" },
        { path: "/dashboard/education", des: true, title: "Education", type: "link" },
      ],
    },
    {
      id: 2,
    ...
    { level: 1, id: 10, path: "/contacts", bookmark: true, title: "Contact", icon: "Contacts", type: "link" },
    { level: 1, id: 11, path: "/task", bookmark: true, title: "Tasks", icon: "Tick-square", type: "link" },
    ...
    { level: 1, id: 15, path: "/search-pages", title: "Search Result", icon: "Search", type: "link" },
    {
    ...
    },
    {
      ...
      children: [
        ...
        { path: "/ui-kits/tabs", color: 'secondary', title: "Tab bootstrap", type: "link" },
      ...
      children: [
        {
          ...
          active: false,
          children: [
            { path: "/forms/form-controls/base-input", title: "Base Input", type: "link" },
            { path: "/forms/form-controls/validation", title: "Form Validation", type: "link" },
            ...
            { path: "/forms/form-controls/input-mask", title: "Input Mask", type: "link" },
    ...
    { level: 1, id: 23, path: "/sample-page", title: "Sample Page", icon: "Paper-plus", type: "link" },
    {
      id: 24,
      level: 1,
      title: "Others",
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: "https://admin.pixelstrap.net/admiro/template/basic-template.html",
              title: "Basic Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/admiro/template/email-header.html",
              title: "Basic With Header",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/admiro/template/template-email.html",
              title: "Ecomerce Template",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/admiro/template/template-email-2.html",
              title: "Email Template 2",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/admiro/template/ecommerce-templates.html",
              title: "Ecommerce Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/admiro/template/email-order-success.html",
              title: "Order Success",
              type: "extTabLink",
            },
          ],
